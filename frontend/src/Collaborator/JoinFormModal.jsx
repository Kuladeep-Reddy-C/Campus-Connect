        ...
        <form onSubmit={handleJoinSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setJoinFormData((prev) => ({ ...prev, userName: e.target.value }))
              }
            ...
            <p className="text-xs text-gray-500 mt-1">
              {joinFormData.username?.length || 0}/30 characters
            </p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setJoinFormData((prev) => ({ ...prev, role: e.target.value }))
              }
              className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#BF0C4F] focus:border-transparent transition-all"
            ...
            />
            <p className="text-xs text-gray-500 mt-1">
              {joinFormData.role?.length || 0}/50 characters
            </p>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                setJoinFormData((prev) => ({ ...prev, motivation: e.target.value }))
              }
            ...
            />
            <p className="text-xs text-gray-500 mt-1">
              {joinFormData.motivation?.length || 0}/500 characters
            </p>
          </div>
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setJoinFormData((prev) => ({ ...prev, availability: e.target.value }))
              }
              className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#BF0C4F] focus:border-transparent transition-all"
              required
            >
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                setJoinFormData((prev) => ({ ...prev, experience: e.target.value }))
              }
              className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#BF0C4F] focus:border-transparent transition-all resize-none"
            ...
            />
            <p className="text-xs text-gray-500 mt-1">
              {joinFormData.experience?.length || 0}/500 characters
            </p>
          </div>
